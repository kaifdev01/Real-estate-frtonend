        ...
        <footer className="bg-gray-900 text-white py-12">
            <div className="max-w-6xl mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <h3 className="text-2xl font-semibold mb-4">Crystal Real Estate</h3>
                        <p className="text-gray-400">Turning dreams into addresses since 2008.</p>
                    </div>
                    <div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-700 text-center">
                    <p>&copy; 2023 Crystal Real Estate. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
